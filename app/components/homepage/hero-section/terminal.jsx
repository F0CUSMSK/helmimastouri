...
const SCRIPTS = [
  {
    ...
    lines: [
      ...
      [{ t: "[+]", c: "cyan" }, { t: " Location: ", c: "gray" }, { t: "Sousse, TN — open to relocation (EU)", c: "white" }],
      [{ t: "[+]", c: "cyan" }, { t: " Languages: ", c: "gray" }, { t: "English · Français · العربية", c: "white" }],
      [{ t: "[+]", c: "cyan" }, { t: " Certs: ", c: "gray" }, { t: "8 (AZ-900 · CCNA · CyberOps · Ethical Hacker …)", c: "white" }],
      [{ t: "", c: "dim" }],
